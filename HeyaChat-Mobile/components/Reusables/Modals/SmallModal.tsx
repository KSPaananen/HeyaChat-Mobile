...
const SmallModalContext = createContext<any>(null)

export const useSmallModalContext = () => {
  try {
    return useContext(SmallModalContext)
  } catch (e) {
    console.log(e)
    throw new Error('useMediumModalContext error in SmallModal.tsx')
  }
}
...
const SmallModal: React.FC<Props> = ({ route, navigation }) => {
  ...
  return (
    <SmallModalContext.Provider value={{ args, setArgs }}>
